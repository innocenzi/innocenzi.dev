...
This driver works by extending an existing disk and configuring a <span class="whitespace-pre">`prefix`,</span> which would be a path to a directory in the extended disk.
